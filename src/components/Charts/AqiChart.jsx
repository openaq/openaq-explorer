      ...
      <div style="position:relative;">
        ...
        >
          ...
          >
            <rect
              width={props.width}
              height={props.height - y(301)}
              y={props.height - (props.height - y(500))}
              x={0}
              fill="maroon"
            ></rect>
            <rect
              width={props.width}
              height={props.height - y(201)}
              y={props.height - (props.height - y(300))}
              x={0}
              fill="purple"
            ></rect>
            <rect
              width={props.width}
              height={props.height - y(151)}
              y={props.height - (props.height - y(200))}
              x={0}
              fill="red"
            ></rect>
            <rect
              width={props.width}
              height={props.height - y(101)}
              y={props.height - (props.height - y(150))}
              x={0}
              fill="orange"
            ></rect>
            <rect
              width={props.width}
              height={props.height - y(51)}
              y={props.height - (props.height - y(100))}
              x={0}
              fill="yellow"
            ></rect>
            <rect
              id=""
              width={props.width}
              height={props.height - y(50)}
              y={props.height - (props.height - y(50))}
              x={0}
              fill="green"
            ></rect>
          </g>
