...
export default function DetailMap(props: DetailMapDefinition) {
  ...
  return (
    ...
    <MapGL
      ...
      options={{
        ...
        dragRotate: true,
        maxZoom: 16,
        maxBounds: bounds([props.coordinates?.longitude, props.coordinates?.latitude])
      }}
      viewport={viewport()}
      onViewportChange={(e) => {
    ...
    >
      ...
      />
      <Marker lngLat={[props.coordinates?.longitude, props.coordinates?.latitude]} options={{ color: '#1E64AB', scale: 1.5}}>
